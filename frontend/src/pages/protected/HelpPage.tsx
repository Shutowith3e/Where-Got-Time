...
export default function HelpPage() {
  return (
    <>
      <NavBar />
      <div className="flex flex-col gap-2 bg-gradient-to-b from-orange-800/20 p-5">
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="flex flex-col gap-4 text-balance p-2 text-slate-700">
              <p>
                ...
                A: It’s a group scheduler designed to make event planning easier
                for friends, clubs, teams, and communities. Each group can
                manage its own calendar, send invites, and avoid time clashes.
              </p>

              <p>
                Q: Do I need an account to use it? <br /> A: Yes, you’ll need to
                sign up to create or join groups.
              </p>

              <p>
                Q: How many groups can I join?
                <br /> A: There's no hard limit. However, each group can have a
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="flex flex-col gap-4 text-balance p-2 text-slate-700">
              <p>
                ...
                “Create New Group” &gt; Fill in group name, description, and
                invite members via email.
              </p>
              <p>
                Q: How do I remove a member from the group? A: Only Admins can
                remove members. <br />
                Go to the member list and click the ❌ icon next to their name.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className="p-4">Troubleshooting</AccordionTrigger>
            <AccordionContent className="flex flex-col gap-4 text-balance p-2 text-slate-700">
              <p>
